...
Ad esempio sono $(f_1(x_1), c_2)$-Binding le formule: 
$p_1(f_1(x_1), c_2)$, $p_1(f_1(x_1), c_2) \lor \lnot p_3(f_1(x_1), c_2)$.
Per semplicità di scrittura è possibile omettere la lista di termini comune e posizionarla in notazione postfissa:

$$p_1(f_1(x_1), c_2) \lor \lnot p_3(f_1(x_1), c_2) \text{ diventa } (p_1 \lor \lnot p_3)(f_1(x_1), c_2)$$
...
Ad esempio $term((p_1 \lor \lnot p_3)(f_1(x_1), c_2)) = (f_1(x_1), c_2)$.
...
$\forall x_1 (p_1(x_1) \lor p_2(x_1)) \land (p_1(c_1) \lor \exists x_2 (p_3(x_2))) \land \lnot p_1(c_1) \land \exists x_2 (p_3(x_2))$
ha la seguente struttura booleana  $c_1 \land (c_2 \lor c_3) \land \lnot c_2 \land c_3$.
Un implicante (e anche il solo) di questa formula è l'insieme $\{c_1, c_3\}$ che ri-convertito nel primo ordine diventa
...
\begin{itemize}
    \item $c_1 \rightleftarrows \forall x_1 (p_1(x_1) \lor p_2(x_1))$
    \item $c_2 \rightleftarrows p_1(c_1)$
    \item $c_3 \rightleftarrows \exists x_2 (p_3(x_2))$
\end{itemize}
...
$((p_1 \land p_4) \lor p_2 \lor \lnot p_4)(\tau)$ viene convertito nella seguente formula proposizionale $(c_1 \land c_4) \lor c_2 \lor \lnot c_4$
