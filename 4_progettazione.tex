...
% In $FtoFree$ vengono inseriti tutti i letterali che hanno la stessa lista di termini del letterale passato in input per essere gestiti dal livello superiore.
